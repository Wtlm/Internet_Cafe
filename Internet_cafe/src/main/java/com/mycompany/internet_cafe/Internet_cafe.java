...
public class Internet_cafe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sID.setText("Subject's name");

        sName.setText("Teacher's name");
        ...
        cID.setText("Date of Lesson");

        cUserID.setText("Subject's name");

        cTime.setText("Teacher's name");
    ...
    private void usersButtonMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_usersButtonMouseClicked
        ...
        connect.displayData("SELECT * FROM Student", UserTable);
        setTable(UserTable);
    ...
    private void staffButtonMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_staffButtonMouseClicked
        ...
        connect.displayData(connect.cmdRelationship(), StaffTable);
        setTable(StaffTable);
    ...
    private void computerButtonMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_computerButtonMouseClicked
        ...
        connect.displayData(connect.cmdLesson(), ComputerTable);
    ...
    private void uAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uAddActionPerformed
        ...
        if(state){
            connect.showAddData("Student", data);
            connect.displayData("SELECT * FROM Student", UserTable);
    ...
    private void uUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uUpdateActionPerformed
        ...
        if(state){
            connect.showUpdateData("Student", data, UserTable);
            connect.displayData("SELECT * FROM Student", UserTable);
            if(connect.modify != false){
    ...
    private void uDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uDeleteActionPerformed
        ...
        if(!data.isEmpty()){
            ...
            if(option == 1){
                connect.showDeleteData("Student", data);
                connect.displayData("SELECT * FROM Attendance", UserTable);
    ...
    private void UserTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UserTableMouseClicked
        connect.selectData("Student", UserTable);
        try {
            while (connect.rs.next()) {
                uidText.setText(connect.rs.getString("StudentName"));
            }
    ...
    private void sAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sAddActionPerformed
        String[] data = { sidText.getText(), snameText.getText() };
        
        boolean state = true;
        if(state){
            connect.insertSubject(data);
            connect.displayData(connect.cmdRelationship(), StaffTable);
            if(connect.modify != false){
                showAddMessage(true);
    ...
    private void cAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cAddActionPerformed
        String[] data = { cidText.getText(), cuseridText.getText(), ctimeText.getText() };
        boolean state = true;
        for(String i: data){
            if(i.isEmpty()){
                state = false;
    ...
    private void SearchBoxKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SearchBoxKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER && evt.isShiftDown()){
            ...
            if (connect.status) {
                ...
                jScrollPane1.setLocation(148, 140);
